...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        <div class="p-4 bg-white/20 backdrop-blur-sm rounded-xl">
                            <span class="material-symbols-outlined text-5xl text-white">library_add</span>
                        </div>
                        <div>
                            <h1 class="text-3xl font-bold text-white">Add New Book</h1>
                            <p class="text-white/90 mt-1">Fill in the details to add a new book to your library</p>
                        </div>
                    </div>
            ...
            <form action="{{ route('library.admin.books.store') }}" method="POST" enctype="multipart/form-data"
                x-data="{ type: '{{ old('type', 'rent') }}' }">
                @csrf
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-1">
                        <div
                            ...
                            <div class="space-y-4">
                                <div
                                    class="aspect-[3/4] bg-gray-100 dark:bg-gray-700 rounded-xl overflow-hidden border-2 border-dashed border-gray-300 dark:border-gray-600 flex items-center justify-center">
                                    <div id="cover-preview" class="hidden w-full h-full">
                                        <img id="cover-image" src="" alt="Cover preview" class="w-full h-full object-cover">
                                    </div>
                                    <div id="cover-placeholder" class="text-center p-6">
                                        <span class="material-symbols-outlined text-6xl text-gray-400 mb-2">book</span>
                                        <p class="text-sm text-gray-500 dark:text-gray-400">Upload cover image</p>
                                    </div>
                                </div>
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div
                            ...
                            <div class="space-y-4">
                                ...
                                <!-- Language -->
                                <div x-data="{ language: '{{ old('language') }}' }">
                                    <label for="language"
                                    ...
                                    <select name="language" id="language" x-model="language"
                                        ...
                                        <option value="Tamil" {{ old('language') == 'Tamil' ? 'selected' : '' }}>Tamil
                                        </option>
                                        <option value="English" {{ old('language') == 'English' ? 'selected' : '' }}>English
                                        </option>
                                        <option value="Telugu" {{ old('language') == 'Telugu' ? 'selected' : '' }}>Telugu
                                        </option>
                                        <option value="Malayalam" {{ old('language') == 'Malayalam' ? 'selected' : '' }}>
                                            Malayalam</option>
                                        <option value="Kannada" {{ old('language') == 'Kannada' ? 'selected' : '' }}>Kannada
                                        </option>
                                        <option value="Bengali" {{ old('language') == 'Bengali' ? 'selected' : '' }}>Bengali
                                        </option>
                                        <option value="Marathi" {{ old('language') == 'Marathi' ? 'selected' : '' }}>Marathi
                                        </option>
                                        <option value="Gujarati" {{ old('language') == 'Gujarati' ? 'selected' : '' }}>
                                            Gujarati</option>
                                        <option value="Punjabi" {{ old('language') == 'Punjabi' ? 'selected' : '' }}>Punjabi
                                        </option>
                                        <option value="Urdu" {{ old('language') == 'Urdu' ? 'selected' : '' }}>Urdu</option>
                                        <option value="Odia" {{ old('language') == 'Odia' ? 'selected' : '' }}>Odia</option>
                                        <option value="Assamese" {{ old('language') == 'Assamese' ? 'selected' : '' }}>
                                            Assamese</option>
                                        <option value="Sanskrit" {{ old('language') == 'Sanskrit' ? 'selected' : '' }}>
                                            Sanskrit</option>
                                        <option value="Hindi" {{ old('language') == 'Hindi' ? 'selected' : '' }}>Hindi
                                        </option>
                                        <option value="Other" {{ old('language') == 'Other' ? 'selected' : '' }}>Other
                                        </option>
                                    </select>
                                    @error('language')
                                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div x-show="type === 'rent' || type === 'both'">
                                    ...
                                    <input type="number" name="rental_price" id="rental_price"
                                        value="{{ old('rental_price') }}" step="0.01" min="0"
                                ...
                                <div x-show="type === 'rent' || type === 'both'">
                                    ...
                                    <input type="number" name="rental_duration_days" id="rental_duration_days"
                                        value="{{ old('rental_duration_days', 7) }}" min="1"
                                        class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all"
                                        placeholder="7">
                                ...
                                <div x-show="type === 'rent' || type === 'both'">
                                    ...
                                    <input type="number" name="late_fee_per_day" id="late_fee_per_day"
                                        value="{{ old('late_fee_per_day', 5.00) }}" step="0.01" min="0"
                                ...
                                <div>
                                    ...
                                    <div class="flex rounded-xl shadow-sm">
                                        ...
                                        <input type="text" name="slug" id="slug" value="{{ old('slug') }}"
                                            ...
                                            placeholder="category-book-title">
                                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (statusInput && quantityInput) {
                function toggleQuantity() {
                    if (statusInput.value === 'unavailable') {
            ...
            categoryInput.addEventListener('change', updateSlug);
