    ...
    <div class="min-h-screen bg-gray-100 dark:bg-gray-900 py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="{{ route('library.admin.categories.create') }}"
                    class="px-4 py-2 bg-primary hover:bg-primary-hover text-white rounded-md font-bold transition-colors shadow-lg">
                    + Add New Category
                </a>
            </div>
                                ...
                                @forelse ($categories as $category)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="{{ route('library.admin.categories.edit', $category) }}"
                                                class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300 mr-3">Edit</a>
                                            <form action="{{ route('library.admin.categories.destroy', $category) }}"
